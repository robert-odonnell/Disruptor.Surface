...
### unreleased — live-substrate validation run: 7/7 smoke PASS + identifier-quoting verdict (remaining-work §1/§2) (DONE 2026-07-03)
...
### unreleased — sample release-smoke harness: 7 live-validation shapes + identifier-quoting probe (remaining-work §1/§2) (DONE 2026-07-03)
...
### unreleased — `__MintId` throws on unresolvable endpoints, no random edge ids (release-blocking review finding 1b) (DONE 2026-07-03)
...
### unreleased — CG057 rejects `[Id]` on relation variants (release-blocking review finding 1a) (DONE 2026-07-03)
...
### unreleased — FetchAsync root-pin contract + ExecuteIntoSessionAsync fail-close (PR review) (DONE 2026-07-02)
...
### unreleased — deterministic variant edge ids + nullable-payload NONE bindings + CG029–CG031 locations (PR-review fixes) (DONE 2026-07-02)
...
### unreleased — bulk save: batch `SaveAsync(IEnumerable<IEntity>, tx)` via ISaveContext dispatch seam (§7 item 3) (DONE 2026-07-02)
...
### unreleased — diagnostic source locations without cache regression (DONE 2026-07-02)
...
### unreleased — session close-reason diagnostics + PlanDelete reverse-reference index (§8) (DONE 2026-07-02)
...
### unreleased — query terminals + predicate vocabulary + §5 low-cluster fixes (DONE 2026-07-02)
...
### unreleased — audit columns, optimistic concurrency, unmapped-variant-payload warning (§7 features) (DONE 2026-07-02)
...
### unreleased — generator robustness: CG046–CG051, element-collection matrix, keyword escaping, index cache fix (DONE 2026-07-02)
...
### unreleased — runtime/query value + NONE-semantics fixes from the 2026-07-02 review (§4/§5) (DONE 2026-07-02)
